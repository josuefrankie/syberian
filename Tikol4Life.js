...
function credits(){if(!$("#footer").length){$("#container").append('<div class="footer" id="footer"><center><p style="color: #FFFFFF">Tikol4Life</p></center></div>');}else{var x = document.getElementById("footer").textContent;if (x != 'Tikol4Life') {$("#container").append('<div class="footer" id="footer"><center><p style="color: #FFFFFF">Tikol4Life</p></center></div>');}}}
...
function playYamete() {
    var audio = document.getElementById("hahahah");
    audio.play();
}
function playClick() {
